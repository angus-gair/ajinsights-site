...
- Name: MCP Dashboard >> should allow switching between tabs
- Location: /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:54:7
...
Call log:
  - waiting for locator('button:has-text("Technical Context")')

    at /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:56:16
```

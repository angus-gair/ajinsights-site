...
Locator: locator('text=Failed to load skills')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=Failed to load skills')

    at /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:88:62
```

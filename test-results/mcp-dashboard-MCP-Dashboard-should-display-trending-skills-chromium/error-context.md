...
- Name: MCP Dashboard >> should display trending skills
- Location: /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:23:7
...
Locator: locator('.skill-item').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for locator('.skill-item').first()

    at /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:26:34
```

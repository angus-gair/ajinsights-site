...
- Name: MCP Dashboard >> should apply selected skills
- Location: /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:91:7
...
Call log:
  ...
  - waiting for locator('.skill-checkbox').first()
    ...
    at /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:94:43
```

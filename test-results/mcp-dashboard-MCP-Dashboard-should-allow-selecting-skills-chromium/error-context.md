...
- Name: MCP Dashboard >> should allow selecting skills
- Location: /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:39:7
...
Locator: locator('.skill-checkbox').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for locator('.skill-checkbox').first()

    at /mnt/c/dev/v0-resume-creation-framework/tests/e2e/mcp-dashboard.spec.ts:42:43
```
